      ...
      <div style={{ maxWidth: '1100px', width: '100%', zIndex: 1 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '20px' }}>
            ...
            <div style={cardStyle}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                <button
                  onClick={() => setDashboardAberto('areas')}
                  style={linkBtnStyle}
                ...
                <button
                  onClick={() => setDashboardAberto('diretor')}
                  style={linkBtnStyle}
                  onMouseEnter={e => { e.currentTarget.style.background = 'rgba(27, 79, 114, 0.05)'; }}
                  onMouseLeave={e => { e.currentTarget.style.background = 'rgba(255, 255, 255, 0.95)'; }}
                >
            ...
            <div style={cardStyle}>
              ...
              <Button
                variant="outline"
                onClick={() => navigate('/ferramentas-apoio')}
                size="md"
        ...
        <div style={{ marginBottom: '32px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '16px' }}>
            <button
              onClick={() => navigate('/planejamento-estrategico/diagnostico')}
        ...
        <div style={{
          ...
          <Button
            variant="primary"
            onClick={() => navigate('/planejamento-estrategico/painel')}
            size="lg"
            style={{
              background: 'linear-gradient(135deg, #1B4F72 0%, #2874A6 100%)',
              color: '#fff',
