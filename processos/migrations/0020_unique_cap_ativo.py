...
#
# Adiciona UniqueConstraint condicional em codigo_processo (apenas ativos).
# A deduplicacao (RunPython) eh irreversivel por design: soft-deletes nao sao
# desfeitos no rollback. O rollback remove apenas a constraint (RemoveConstraint).
