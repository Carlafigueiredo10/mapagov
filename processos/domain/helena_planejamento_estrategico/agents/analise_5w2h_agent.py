...
class Analise5W2HAgent:
    ...
    def processar_mensagem(self, mensagem: str, estrutura_atual: dict) -> dict:
        return {
            'campo': 'erro',
            'valor': None,
            'proxima_pergunta': "⚠️ 5W2H ainda em desenvolvimento. Em breve!",
            'completo': False,
            'percentual': 0
        }
    ...
    def validar_estrutura(self, estrutura: dict) -> tuple[bool, str]:
        return False, "5W2H em desenvolvimento"

    def gerar_resumo(self, estrutura: dict) -> str:
        return "# Plano de Ação 5W2H (em desenvolvimento)\n"
